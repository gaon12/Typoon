...
object KeyboardMapper {
    private val ENG_TO_KOR_MAP = mapOf(
    ...
    fun mapEngToKor(char: Char): String? {
        return ENG_TO_KOR_MAP[char] ?: ENG_TO_KOR_MAP[char.lowercaseChar()]
    }

    fun mapKorToEng(jamo: Char): String? {
        return KOR_TO_ENG_MAP[jamo]
    }
}
